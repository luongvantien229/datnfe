$(document).ready(function (){
  ...
  $slickElement.slick({
    ...
    arrows: true,
    prevArrow:
      '<span class="testimonial-icon-2-prev"><i class="far fa-angle-left"></i></span>',
    nextArrow:
      '<span class="testimonial-icon-2-next"><i class="far fa-angle-right"></i></span>',
  });
