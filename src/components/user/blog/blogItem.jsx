    ...
    <div className="col-lg-4 col-md-6 col-12 col-sm-6 grid-item wow tmFadeInUp">
      <div className="blog-wrap-2 mb-30">
        <div className="blog-img-2">
          <a href={`blog-detail/${post.slug}/${post.id}`}>
            <img src={post.image} alt={post.title} />
          </a>
          <div className="blog-tag-2">
            <a href={`blog-detail/${post.slug}/${post.id}`}>Tin nóng</a>
          </div>
        </div>
        <div className="blog-content-2">
          <div className="blog-meta-2">
            <ul>
              ...
              <li>
                <i className="far fa-eye"></i> <span>{post.view}</span> lượt xem
              </li>
            </ul>
          </div>
          <h3>
            <a href={`blog-detail/${post.slug}/${post.id}`}>{post.title}</a>
          </h3>
