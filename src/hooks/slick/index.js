...
const useSlick = () => {
  ...
  const proDecBigImg = useRef(null);
  const proDocSliderSmall = useRef(null);
  ...
  useEffect(() => {
    ...
    if (proDecBigImg.current) {
      $(proDecBigImg.current).slick({
        slidesToShow: 1,
        slidesToScroll: 1,
        arrows: false,
        draggable: false,
    ...
    if (proDocSliderSmall.current) {
      $(proDocSliderSmall.current).slick({
          slidesToShow: 4,
          slidesToScroll: 1,
    ...
    return () => {
      ...
      if (proDecBigImg.current) {
        $(proDecBigImg.current).slick("unslick");
      }
      if (proDocSliderSmall.current) {
        $(proDocSliderSmall.current).slick("unslick");
      }
    };
  }, []);
